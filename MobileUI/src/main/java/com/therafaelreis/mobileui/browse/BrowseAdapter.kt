...
class BrowseAdapter @Inject constructor(): RecyclerView.Adapter<BrowseAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(view: View): RecyclerView.ViewHolder(view) {
        ...
        init {
            avatarImage = view.findViewById(R.id.iv_owner_avatar)
            ownerNameText = view.findViewById(R.id.tv_owner_name)
            projectNameText = view.findViewById(R.id.tv_project_name)
